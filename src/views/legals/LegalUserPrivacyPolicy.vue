...
<template>
    <h1>
        Gembase.io, s.r.o’s User’s Privacy Policy
    </h1>
    <div>
        <p>
            Your privacy is important to us. It is Gembase.io, s.r.o.'s policy to respect your privacy and
            comply with any applicable law and regulation regarding any personal information we may collect
            about you, including across our website, https://gembase.io, and other sites we own and operate.
        </p>
        <p>
            <b>
                Personal information is any information about you which can be used to identify you.
            </b>
            This includes information about you as a person (such as name, address, and date of birth), your
        ...
        <p>
            ...
            collect and use personal information. This User’s Privacy Policy does not apply to any of
            your activities after you leave our site.
        </p>
        <p>
            This policy is effective as of 12 January 2024
        </p>
        <p>
    ...
    <div>
        <p>
            We may ask for personal information — for example, when you subscribe to our newsletter
    ...
    <div>
        ...
        <p>
            ...
            and personal information will not be further processed in a manner that is incompatible
            with these purposes:
        </p>
        <div>
            <ul>
        ...
        <p>
            ...
            with general information or research data we receive from other trusted sources.
            For example, If you provide us with your location, we may combine this with general
            information about currency and language to provide you with an enhanced experience of our
            site and service.
        </p>
    </div>
    <h1>
    ...
    <div>
        ...
        <p>
            ...
            ensuring the security of your own information within the bounds of our services. For example,
    ...
    <div>
        <p>
            ...
            depend on what we are using your information for, in accordance with this User’s
            Privacy Policy. For example, if you have provided us with personal information as part of
            creating an account with us, we may retain this information for the duration your account
            exists on our system. If your personal information is no longer required for this purpose,
        ...
        <p>
            ...
            a legal, accounting, or reporting obligation or for archiving purposes in the public interest,
        ...
        <div>
            <ul>
                ...
                <li>
                    ...
                    hosting and server providers,ad networks,analytics,error loggers, debt collectors,
                    maintenance or problem-solving providers, marketing providers,professional advisors,
                ...
                <li>
                    ...
                    by law, in connection with any actual or prospective legal proceedings, or in order
                    to establish, exercise, or defend our legal rights
                </li>
                <li>
                    third parties, including agents or subcontractors who assist us in providing information,
    ...
    <div>
        <p>
            <b>Your choice:</b> By providing personal information to us, you understand we will collect,
            hold, use, and disclose your personal information in accordance with this User’s
            Privacy Policy. You do not have to provide personal information to us, however, if you
            do not, it may affect your use of our website or the products and/or services offered
            on or through it.
        </p>
        <p>
            <b>Information from third parties:</b> If we receive personal information about you from a
            third party, we will protect it as set out in this User’s Privacy Policy. If you are a
        ...
        <p>
            <b>Marketing permission:</b> If you have previously agreed to us using your personal information
            for direct marketing purposes, you may change your mind at any time by contacting us
        ...
        <p>
            ...
            User’s Privacy Policy. We will take reasonable steps to correct any information found to be
        ...
        <p>
            <b>Notification of data breaches:</b> We will comply with laws applicable to us in respect of
            any data breach.
        </p>
        <p>
            <b>Complaints:</b> If you believe that we have breached a relevant data protection law and wish
            to make a complaint, please contact us using the details below and provide us with full
            details of the alleged breach. We will promptly investigate your complaint and respond
            to you, in writing, setting out the outcome of our investigation and the steps we will
            take to deal with your complaint. You also have the right to contact a regulatory body
        ...
        <p>
            ...
            this User’s Privacy Policy, or opt-out using the opt-out facilities provided in the
    ...
    <div>
        <p>
            At our discretion, we may change our User’s Privacy Policy to reflect updates to our
            business processes, current acceptable practices, or legislative or regulatory changes.
            If we decide to change this User’s Privacy Policy, we will post the changes here at the
            same link by which you are accessing this User’s Privacy Policy.
        </p>
        <p>
    ...
    <div>
        <p><b>Data Controller / Data Processor</b></p>
        <p>
            The GDPR distinguishes between organizations that process personal information for
            their own purposes (known as "data controllers") and organizations that process personal
            information on behalf of other organizations (known as "data processors").
            We, Gembase.io, s.r.o., located at the address provided in our Contact Us section,
            are a Data Controller and Processor with respect to the personal information you provide to us.
        </p>
        <p><b>Legal Bases for Processing Your Personal Information</b></p>
        <p>
            ...
            transparent manner. If we seek your consent to process your personal information, and
        ...
        <p>
            ...
            however this will not affect any use of your information that has already taken place.
            You may consent to providing your email address for the purpose of receiving marketing
            emails from us. While you may unsubscribe at any time, we cannot recall any email we
            have already sent. If you have any further enquiries about how to withdraw your consent,
            please feel free to enquire using the details provided in the Contact Us section of
            this User’s Privacy Policy.
        </p>
        <p><b>Performance of a Contract or Transaction</b></p>
        <p>
        ...
        <p><b>Our Legitimate Interests</b></p>
        <p>
        ...
        <p>
            ...
            enquire using the details provided in the Contact Us section of this User’s Privacy Policy.
        </p>
        <p><b>International Transfers Outside of the European Economic Area (EEA)</b></p>
        <p>
            We will ensure that any transfer of personal information from countries in the
            European Economic Area (EEA) to countries outside the EEA will be protected by appropriate
    ...
    <div>
        <p>
            ...
            (iii) you need us to maintain the personal information solely for the purpose of a
            legal claim; or (iv) we are in the process of considering your objection in relation to
        ...
        <p>
            <b>Data portability:</b> You may have the right to request a copy of the personal information
            we hold about you. Where possible, we will provide this information in CSV format or other easily
        ...
        <p>
            ...
            information from our current records. If you ask us to delete your personal information, we
            will let you know how the deletion affects your use of our website or products and services.
            There may be exceptions to this right for specific legal reasons which, if applicable, we
            will set out for you in response to your request. If you terminate or delete your account,
            we will delete your personal information within 120 days of the deletion of your account.
            Please be aware that search engines and similar third parties may still retain copies of your
            personal information that has been made public at least once, like certain profile
            information and public comments, even after you have deleted the information from our
    ...
    <div>
        <p>
            ...
            following email address: contact@gembase.io
        </p>
    </div>
</template>
